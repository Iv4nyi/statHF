...
\begin{document}
    ...
    \section{Statisztikai Elemzés - Mesehősök Gumimaci
Pontszámai}\label{statisztikai-elemzuxe9s---mesehux151suxf6k-gumimaci-pontszuxe1mai}

\subsection{Adatok beolvasása és
előkészítése}\label{adatok-beolvasuxe1sa-uxe9s-elux151kuxe9szuxedtuxe9se}

    \subsubsection{Szükséges könyvtárak
...
\end{tcolorbox}
    ...
    \subsubsection{Adatok beolvasása}\label{adatok-beolvasuxe1sa}
